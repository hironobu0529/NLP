...
"""
2024/11/23: sentenceBERTによるsentence similarity. 
round robin fashion　のみのコード
"""
...
def countFeatures(data_rrb, subjectID, visit, part):
        ...
        if ((target1 in file[i]) == True) or ((target2 in file[i]) == True):
            try:
                ...
                try:
                    ...
                    df_Features = countFeatures(similarity_list_rrb, subid, subvisit, subpart)
